...
{
    private const string DomainNamespace = "BusDelivery.Domain";
    private const string ApplicationNamespace = "BusDelivery.Application";
    private const string InfrastructureNamespace = "BusDelivery.Infrastructure";
    private const string PersistenceNamespace = "BusDelivery.Persistence";
    private const string PresentationNamespace = "BusDelivery.Presentation";
    private const string ApiNamespace = "BusDelivery.API";
